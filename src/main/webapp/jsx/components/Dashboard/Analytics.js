									...
									<div className="d-flex align-items-center mt-4 justify-content-center">
										<div className="d-inline-block position-relative donut-chart-sale mb-3">
											{background.value === "dark" ? (
											  ...
											  <AnalyticsDonut value={84} backgroundColor="rgb(14, 138, 116,1)" />
											)}
											<small>84%</small>
										</div>
										<div className="ms-4">
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="progress" style={{height:"9px"}}>
										<div className="progress-bar bg-secondary progress-animated" style={{width: "80%", height:"9px"}} role="progressbar">
